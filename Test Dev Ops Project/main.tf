##### Begin Resource Grp #####
resource "azurerm_resource_group" "rg-devopsdw-01" {
  name     = "rg-sc-sub1-vpt-test-devopsdw-01"
  location = "South Central US"
}
##### End Resource Grp #####

##### Networking Start #####
resource "azurerm_network_security_group" "nsg-devopsdw-01" {
  name                = "nsg-snet-sc-sub1-vpt-test-devopsdw-01"
  resource_group_name = azurerm_resource_group.rg-devopsdw-01.name
  location            = azurerm_resource_group.rg-devopsdw-01.location
}

resource "azurerm_virtual_network" "vnet-devopsdw-01" {
  name                = "vnet-sc-sub1-vpt-test-devopsdw-01"
...
resource "azurerm_subnet" "snet-asr-01" {
  ...
  virtual_network_name = azurerm_virtual_network.vnet-devopsdw-01.name
  resource_group_name  = "rg-sc-sub1-vpt-test-devopsdw-01"
